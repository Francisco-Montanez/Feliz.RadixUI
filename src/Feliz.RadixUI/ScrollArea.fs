...
type [<Erase>] scrollArea =
    ...
    static member inline root (props: IReactProperty seq) = createElement (import "ScrollArea" "@radix-ui/react-scroll-area") props
    /// The viewport area of the scroll area.
    static member inline viewport (props: IReactProperty seq) = createElement (import "ScrollAreaViewport" "@radix-ui/react-scroll-area") props
    /// The vertical scrollbar. Add a second Scrollbar with an orientation prop to enable horizontal scrolling.
    static member inline scrollbar (props: IReactProperty seq) = createElement (import "ScrollAreaScrollbar" "@radix-ui/react-scroll-area") props
    /// The thumb to be used in ScrollArea.Scrollbar.
    static member inline thumb (props: IReactProperty seq) = createElement (import "ScrollAreaThumb" "@radix-ui/react-scroll-area") props
    /// The corner where both vertical and horizontal scrollbars meet.
    static member inline corner (props: IReactProperty seq) = createElement (import "ScrollAreaCorner" "@radix-ui/react-scroll-area") props
