namespace Feliz.RadixUI.HoverCard
...
type [<Erase>] hoverCard =
    ...
    static member inline root (props: IReactProperty seq) = createElement (import "Root" "@radix-ui/react-hover-card") props
    /// The link that opens the hover card when hovered.
    static member inline trigger (props: IReactProperty seq) = createElement (import "Trigger" "@radix-ui/react-hover-card") props
    /// When used, portals the content part into the body.
    static member inline portal (props: IReactProperty seq) = createElement (import "Portal" "@radix-ui/react-hover-card") props
    /// The component that pops out when the hover card is open.
    static member inline content (props: IReactProperty seq) = createElement (import "Content" "@radix-ui/react-hover-card") props
    ...
    static member inline arrow (props: IReactProperty seq) = createElement (import "Arrow" "@radix-ui/react-hover-card") props
